...
declare type NonReactStatics<S extends OmniComponent, C extends ExcludeList = {}> = {
    [key in Exclude<keyof S, S extends MemoExoticComponent<any> ? keyof typeof MEMO_STATICS | keyof C : S extends ForwardRefExoticComponent<any> ? keyof typeof FORWARD_REF_STATICS | keyof C : keyof typeof REACT_STATICS | keyof typeof KNOWN_STATICS | keyof C>]: S[key];
};
